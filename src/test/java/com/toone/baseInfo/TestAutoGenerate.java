...
//        gc.setDateType(DateType.ONLY_DATE);
        ...
        // 配置数据库 url 地址
        dsc.setUrl("jdbc:mysql://42.192.71.130:3306/huangbhDb?serverTimezone=UTC");
        ...
        // Step:4：包配置
        String parentPackge="sysMenu";
        PackageConfig pc = new PackageConfig();
        // 配置父包名（需要修改）
        pc.setParent("com.toone.hbh.business");
        // 配置模块名（需要修改）
//        pc.setModuleName("UserController");
        // 配置 entity 包名
        pc.setEntity(parentPackge+".entity");
        // 配置 mapper 包名
        pc.setMapper("mapping."+parentPackge);
        // 配置 service 包名
